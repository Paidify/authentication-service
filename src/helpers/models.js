export default {
    'univ': {
        ...
        'payment_concept_person': ['id', 'person_id', 'payment_concept_id', 'ref_number'],
    },
    'paidify': {
        'address': ['id', 'address_line', 'zip_code', 'city_id'],
        ...
        'payment': ['id', 'credit_card_auth_code', 'amount', 'balance', 'date', 'effective_date', 'gateway_date', 'ref_number', 'num_installments', 'fulfilled', 'operation_status_id', 'payment_concept_id', 'campus_id', 'card_type_id', 'payer_id'],
